...
cd ..
cp profile_approval_and_issue_flow/issue_admin.rb $APP_NAME/app/admin/issue.rb

echo "active admin issue form"
mkdir $APP_NAME/app/admin/views
cp profile_approval_and_issue_flow/create_issue_admin.haml $APP_NAME/app/admin/views/create_issue.haml
