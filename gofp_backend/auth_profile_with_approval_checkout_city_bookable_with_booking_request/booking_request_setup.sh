...
cp booking_request_setup/booking_requests_controller.rb $APP_NAME/app/controllers/$BOOKING_REQUEST_NAME_SNAKE_PLURAL.rb
replace_bookable_asset_and_booking_request_strings $APP_NAME/app/controllers/$BOOKING_REQUEST_NAME_SNAKE_PLURAL.rb
...
cd $APP_NAME
git add .
git commit -m "adding $BOOKING_REQUEST_NAME ruby & haml"
cd ..