...
cp paypal_and_stripe/payment_modal.haml $APP_NAME/app/views/orders/_payment_modal.haml
cp paypal_and_stripe/purchase_item.css.sass $APP_NAME/app/assets/stylesheets
