ActiveAdmin.register Profile do
  ...
  show do |profile|
    attributes_table do
      ...
      row :updated_at
      row "Pic medium" do
        image_tag URI.unescape(profile.user.avatar.image.url(:medium))
      end
      row "link to original" do
        link_to profile.user.avatar.image.url, URI.unescape(profile.user.avatar.image.url), target: "_blank"
      end
