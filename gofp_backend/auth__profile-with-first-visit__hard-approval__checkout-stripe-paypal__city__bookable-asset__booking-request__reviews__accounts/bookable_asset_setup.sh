...
cd $APP_NAME
rails g model $BOOKABLE_ASSET_NAME_CAMEL status user:references amount_cents:integer
rake db:migrate
cd ..
...
echo "add profile & bookable asset publish manager"
cp bookable_asset_setup/profile_and_bookable_asset_publish_manager.rb $APP_NAME/lib/profile_and_$BOOKABLE_ASSET_NAME'_publish_manager.rb'
replace_bookable_asset_strings $APP_NAME/lib/profile_and_$BOOKABLE_ASSET_NAME'_publish_manager.rb'

echo "copy controller"
cp bookable_asset_setup/bookable_asset_controller.rb $APP_NAME/app/controllers/$BOOKABLE_ASSET_NAME_SNAKE_PLURAL'_controller'.rb
replace_bookable_asset_strings $APP_NAME/app/controllers/$BOOKABLE_ASSET_NAME_SNAKE_PLURAL'_controller'.rb
...
cd $APP_NAME
rails g active_admin:resource $BOOKABLE_ASSET_NAME_CAMEL
cd ..
