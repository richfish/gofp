...
echo "add generic mvc generators for adding new models"
cp ../generic_mvc_generators/generic_form.rake $APP_NAME/lib/tasks
cp ../generic_mvc_generators/generic_view.rake $APP_NAME/lib/tasks
...
#git
echo "initializing git; first commit of common files"
cd $APP_NAME
git init
git add .
