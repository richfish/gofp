class Profile < ActiveRecord::Base
   ...
   #FOR BOILERPLATE EXAMPLES, REMOVE
  ...
  STATUSES = [STATUS_NEW, STATUS_UNPUBLISHED_PENDING_APPROVAL, STATUS_FIX_ISSUE_WINDOW_UNPUBLISHED, STATUS_PUBLISHED, STATUS_REJECTED, STATUS_BLOCKED] #add others

  #APPROVAL_FIELDS = [:first_name, :service_description, :datingbio]
  ...
  def unpublished_pending_approval?
    self.status == STATUS_UNPUBLISHED_PENDING_APPROVAL
  end
