...
cp devise_setup/confirmation_instructions.haml $APP_NAME/app/views/users/mailer/confirmation_instructions.html.haml
...
echo "add Devise mailer"
cp devise_setup/devise_mailer.rb $APP_NAME/app/mailers/

echo "add User mailer"
cp devise_setup/user_mailer.rb $APP_NAME/app/mailers/
